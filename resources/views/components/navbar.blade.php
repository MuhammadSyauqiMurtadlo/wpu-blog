          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3 z-50">
              ...
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer" type="button" @click="isOpen = !isOpen" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                ...
                <img src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('img/default-avatar.jpg') }}" alt="{{ Auth::user()->name }}" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
    ...
    <div id="mobile-menu" x-show="isOpen" x-transition class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        ...
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('img/default-avatar.jpg') }}" alt="{{ Auth::user()->name }}" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
