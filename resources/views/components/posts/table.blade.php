<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-xl font-semibold pl-4 mb-4 text-gray-900 dark:text-white">Post By: {{ Auth::user()->name }} </h2>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="post-{{ $post->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="post-{{ $post->id }}-dropdown-button">
                                        ...
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}" data-modal-target="readProductModal1" data-modal-toggle="readProductModal1" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
